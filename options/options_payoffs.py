...
class OptionStrategy:
    ...
    def calculate_payouts(self):
        for trade in self.options:
            asset_price = trade["asset_price"]  # noqa: F841
    ...
    def plot_payouts(self, to_screen=False):
        ...
        combined_payouts = [sum(payout) for payout in zip(*self.payouts.values(), strict=False)]
    ...
    def print_summary(self):
        ...
        is_spread = any(
            trade["option_type"] == "call" and trade["position"] == "long" for trade in self.options
        ) and any(trade["option_type"] == "call" and trade["position"] == "short" for trade in self.options)
